        ...
        @foreach($all_brand_product as $key => $cate_pro)
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('Are you ready?')" href="{{URL::to('/delete-brand-product/'.$cate_pro->brand_id)}}" class="active styling-delete" ui-toggle-class="">
