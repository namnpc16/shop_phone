							...
							<div class="product-information"><!--/product-information-->
								...
								<form action="{{URL::to('/save-cart')}}" method="post">
									...
									<span>
										...
										<input type="hidden" min="1" name="product_id" value="{{$value->product_id}}" />
...
@endforeach
						...
						<div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
							<div class="carousel-inner">
								@foreach($relative_product as $key => $relative_pro)
								<div class="item active">
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
													<div class="productinfo text-center">
														<img src="{{URL::to('public/uploads/product/'.$relative_pro->product_image)}}" alt="" />
														<h2>{{number_format($relative_pro->product_price).' '.'VND'}}</h2>
														<p>{{$relative_pro->product_name}}</p>
