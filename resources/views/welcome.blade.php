				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="{{ URL::to('/check-login') }}"><i class="fa fa-star"></i> Yêu thích</a></li>
								<?php
								...
								<?php
									...
									?>
										<li><a href="{{ URL::to('/check-login') }}"><i class="fa fa-crosshairs"></i> Thanh toán</a></li>
								<?php
									}
								?>
								...
								<?php
										...
										if ($id_customer != Null) {
									?>
										<li><a href="{{ URL::to('/check-logout') }}"><i class="fa fa-lock"></i> Đăng xuất</a></li>
								<?php
									} else {
									?>
										<li><a href="{{ URL::to('/check-login') }}"><i class="fa fa-lock"></i> Đăng nhập</a></li>
								<?php
										}
									?>
							</ul>
				...
				<div class="row">
					<div class="col-sm-8">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="{{URL::to('/trang-chu')}}" class="active">Trang chủ 1</a></li>
					...
					<div class="col-sm-4">
						...
						<div class="search_box pull-right">
							@csrf
							<input type="text" name="keywords_search" placeholder="Search"/>
							<input type="submit" value="Search" style="margin-top:0; color: #333333;" class="btn btn-primary btn-sm">
						</div>
						</form>
					</div>
				</div>
